...
public class Plugin : PluginController<Plugin>
{
    ...
    private void BindConfigs()
    {
        ...
        Settings.MurderFailPenalty = Config.Bind("SocialCredit", "DeathAndTaxes.MurderFailPenalty", 100, "If you fail a murder case, how much social credit should we deduct? (requires AdjustSocialCreditOnJobCompletion to be true)");
        ...
        Settings.SocialCreditLossOnFine = Config.Bind("SocialCredit", "DeathAndTaxes.SocialCreditLossOnFined", true, "Apply a social credit penalty when escaping a fine?");
        Settings.FinedSocialCreditLossModifier = Config.Bind("SocialCredit", "DeathAndTaxes.FinedSocialCreditLossModifier", 1f, "What percentage of fines should be converted to social credit (1=100%)? (Requires SocialCreditLossOnDeath to be true)");
